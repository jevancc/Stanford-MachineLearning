...
% Part 2 & Part 3: backpropagation algorithm to compute the gradients with
%                  regularizations

delta3 = a3 - y;
delta2 = delta3*Theta2 .* sigmoidGradient([ones(m,1) a1*Theta1.']);
delta2 = delta2(:,2:end);
